...
function DropdownMenuCheckboxItem({
  ...
  return (
    <Menu.CheckboxItem
      ...
      className={cn(
        "focus:bg-accent focus:text-accent-foreground relative flex cursor-default items-baseline gap-2 rounded-sm py-2 pr-3 pl-8 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      checked={checked}
      {...props}
    >
      <span className="pointer-events-none absolute left-2 flex size-3.5 justify-center">
...
function DropdownMenuSubContent({
  ...
  return (
    <Menu.Positioner data-slot="dropdown-menu-sub-content" {...props}>
      <Menu.Popup
        className={cn(
